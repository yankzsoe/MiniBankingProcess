namespace Transaction.Framework.Services {
    ...
    public class TransactionService : ITransactionService {
        ...
        public async Task<TransactionResult> Balance(string accountNumber) {
        ...
        public async Task<bool> Register(AccountSummary accountSummary) {
            var account = _mapper.Map<AccountSummaryEntity>(accountSummary);
            var result = await _accountSummaryRepository.Insert(account);
        ...
        private async Task<AccountSummary> GetAccountSummary(string accountNumber) {
